...
@section('title', 'Profil Saya | Admin Kecamatan PKK Kab. Indramayu')
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    <!-- Post -->
                    <form class="form-horizontal" action="{{ route('update_profil_admin_kec', $adminKec->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset('uploads/'.$adminKec->foto) }}" class="img-thumbnail" width="100px">
